...
sed -i "" "s|name: default|name: $NAME|" $NAME-kubeconfig.yaml
sed -i "" "s|user: default|user: $NAME|" $NAME-kubeconfig.yaml
sed -i "" "s|cluster: default|cluster: $NAME|" $NAME-kubeconfig.yaml
sed -i "" "s|current-context: default|current-context: $NAME|" $NAME-kubeconfig.yaml
